...
public class SwipeRecyclerView extends FrameLayout
        ...
        recyclerView.setOnScrollListener(new OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (mLayoutManager instanceof LinearLayoutManager) {
                    ...
                    lastVisiablePosition = ((GridLayoutManager) mLayoutManager).findLastVisibleItemPosition();
                ...
                if (dy > 0 && childCount > 1 && lastVisiablePosition == childCount - 1) {
    ...
    /**
     * make recyclerView scroll to top position
     */
